...
//CustomColorPicker creado a partir de ColorPicker de petrov kristian, para poder añadir un campo de modificacion del
//nombre de una tierRow ademas de su color, es exactamente la misma clase pero con un campo mas y unos metodos para poder
//modificarlo
public class CustomColorPicker{
    ...
    //EditText para La tierRow
    private EditText et_label;

    /**
     * Constructor
     */
    public CustomColorPicker(Activity context) {
        dialogViewLayout = LayoutInflater.from(context).inflate(R.layout.custom_color_picker_dialog, null, false);
        ...
        //para tierRow
        et_label = dialogViewLayout.findViewById(R.id.custom_color_picker_et_label);
    }

    //para tierRow
    public void setLabel(String rowName) {
        this.et_label.setText(rowName);
    }

    public String getLabelName() {
        return this.et_label.getText().toString();
    }
     ...
     * @return this
     */
    public CustomColorPicker setColors(int resId) {
        if (mContext == null)
            return this;
     ...
     * @return this
     */
    public CustomColorPicker setColors(ArrayList<String> colorsHexList) {
        colors = new ArrayList<>();
     ...
     * @return this
     */
    public CustomColorPicker setColors(int... colorsList) {
        colors = new ArrayList<>();
     ...
     * @return this
     */
    public CustomColorPicker setDefaultColorButton(int color) {
     ...
     * @return this
     */
    public CustomColorPicker setColumns(int c) {
        columns = c;
        return this;
    }
     ...
     * @return this
     */
    public CustomColorPicker setTitle(String title) {
        this.title = title;
        return this;
    }
     ...
     * @return this
     */
    public CustomColorPicker setColorButtonTickColor(int color) {
     ...
     * @return this
     */
    public CustomColorPicker setColorButtonDrawable(int drawable) {
     ...
     * @return this
     */
    public CustomColorPicker setColorButtonSize(int width, int height) {
     ...
     * @return this
     */
    public CustomColorPicker setColorButtonMargin(int left, int top, int right, int bottom) {
     ...
     * @return this
     */
    public CustomColorPicker setRoundColorButton(boolean roundButton) {
     ...
     * @return this
     */
    public CustomColorPicker setOnFastChooseColorListener(ColorPicker.OnFastChooseColorListener listener) {
     ...
     */
    public CustomColorPicker setOnChooseColorListener(ColorPicker.OnChooseColorListener listener) {
     ...
     * @return this
     */
    public CustomColorPicker addListenerButton(String text, Button button, final ColorPicker.OnButtonListener listener) {
     ...
     * @return this
     */
    public CustomColorPicker addListenerButton(String text, final ColorPicker.OnButtonListener listener) {
        if (mContext == null)
            return this;
     ...
     * @return this
     */
    public CustomColorPicker setDismissOnButtonListenerClick(boolean dismiss) {
     ...
     * @return this
     */
    public CustomColorPicker setDialogFullHeight() {
     ...
     * @return this
     */
    public CustomColorPicker disableDefaultButtons(boolean disableDefaultButtons) {
     ...
     * @return this
     */
    public CustomColorPicker setTitlePadding(int left, int top, int right, int bottom) {
     ...
     * @return this
     */
    private CustomColorPicker setColors() {
        if (mContext == null)
            return this;
    ...
    private CustomColorPicker setMargin(int left, int top, int right, int bottom) {
